        ...
        html5_qrcode: function (qrcodeSuccess, qrcodeError, videoError) {
            return this.each(function () {
                ...
                var localMediaStream,
                    ...
                    video = vidElem[0], canvas = canvasElem[0], context = canvas.getContext("2d"), scan = function () {
                        if (localMediaStream) {
                ...
                navigator.getUserMedia ? navigator.getUserMedia({video: !0}, successCallback, function (error) {
