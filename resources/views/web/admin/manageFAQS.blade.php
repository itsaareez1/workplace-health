    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="post" action="{{url('deleteFaqs')}}">
                ...
                <table class="table dataset__table table__actions">
                    ...
                    @foreach ($results as $faq)
                        <tr>
                            ...
                            <td>
                                <div class="table__cell-widget">
                                    <a href="#" class="table__cell-widget-name">{{ $faq->questions }}</a>
                                </div>
                            </td>
                                ...
                                <div class="table__cell-actions-wrap">
                                    <div class="dropdown table__cell-actions-item">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" onclick="deleteFaqOpenModal({{$faq->id}})"
                                               href="#.">Delete</a>
                                            <a class="dropdown-item"
                                               href="{{url('wh-editFaqs')}}/{{$faq->id}}">Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
