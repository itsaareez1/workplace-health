...
<div class="page-content">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="post" action="{{url('deleteProgram')}}">
    ...
    <div class="container-fluid container-fh">
        <div class="page-content__header">
            <div>
                <h2 class="page-content__header-heading">Manage Programs</h2>
                <ol class="breadcrumb">
        ...
        <div class="container-fh__content dataset">
            <div class="dataset__header">
                <div class="dataset__header-side">
                    <div class="dataset__header-heading">Programs</div>
                        ...
                        <tr>
                            <td class="table__checkbox">
                                <div class="table__cell-widget">
                                    <a href="#" class="table__cell-widget-name">{{ $program->id }}</a>
                                </div>
                            </td>
                            <td>
                                <div class="table__cell-widget">
                                    <a href="#" class="table__cell-widget-name">{{ $program->company_name }}</a>
                                </div>
                            </td>
                            <td>
                                <div class="table__cell-widget">
                                    <a href="#" class="table__cell-widget-name">{{ $program->name }}</a>
                                </div>
                            </td>
                            <td>
                                <div class="table__cell-user">
                                    <div class="table__cell-user-wrap">
                                        <a href="#" class="table__cell-widget-name">{{ $program->created_at }}</a>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="table__cell-widget">
                                    <span class="table__cell-widget-name">{{ $program->updated_at }}</span>
                                </div>
                            </td>
                                ...
                                <div class="table__cell-actions-wrap">
                                    <div class="dropdown table__cell-actions-item">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" onclick="deleteProgramOpenModal({{$program->id}})"
                                               href="#.">Delete</a>
                                            <a class="dropdown-item" href="{{url('wh-editProgram')}}/{{$program->id}}">Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
...
<script>
    function deleteProgramOpenModal(id) {
