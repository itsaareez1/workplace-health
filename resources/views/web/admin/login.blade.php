            ...
            <span class="action-alert__action-message">{{ session()->get('status') }}</a>
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="email" class="form-control" name="email" id="p-signin-work-email"
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="password" class="form-control" name="password" id="p-signin-set-password"
                               placeholder="Password" required>
                    </div>
                </div>
                <a href="{{url('wh-admin-forgetpassword')}}" style="float:right;">Forget Password?</a>
                <div>
