...
<div class="page-content">
    ...
    <div class="container-fluid container-fh">
        <div class="page-content__header">
            <div>
                <h2 class="page-content__header-heading">Manage Products</h2>
                <ol class="breadcrumb">
        ...
        <div class="container-fh__content dataset">
            <div class="dataset__header">
                <div class="dataset__header-side">
                    <div class="dataset__header-heading">Products</div>
                        ...
                        <tr>
                            <td class="table__checkbox">
                                <div class="table__cell-widget">
                                    <a href="#" class="table__cell-widget-name">{{ $product->id }}</a>
                                </div>
                            </td>

                            <td class="table__checkbox">
                                <div class="table__cell-widget">
                                    <a href="#" class="table__cell-widget-name"><img style="width: 50px; height: 50px;" src="{{asset('storage/')}}/{{$product->img}}" class="table__cell-user-avatar rounded-circle"></a>
                                </div>
                            </td>
                            <td>
                                <div class="table__cell-widget">
                                    <a href="#" class="table__cell-widget-name">{{ $product->name }}</a>
                                </div>
                            </td>
                            <td>
                                <div class="table__cell-widget">
                                    <span class="table__cell-widget-name">
                                        <?php
                                        if ($product->type == 1) {
                                            echo $product->price;
                                        } else {
                            ...
                            <td>
                                <div class="table__cell-user">
                                    {{--<img src="{{asset('admin/img/users/user-10.png')}}" alt=""--}}
                                    {{--<img src="{{asset('storage/')}}/{{$product->img}}"--}}
                                         {{--class="table__cell-user-avatar rounded-circle">--}}
                                    <div class="table__cell-user-wrap">
                                        <a href="#" class="table__cell-widget-name">
                                            <?php
                                            if ($product->type == 1) {
                                                echo 'Price Product';
                                            } else {
                                ...
                                <div class="table__cell-actions-wrap">
                                    <div class="dropdown table__cell-actions-item">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" onclick="deleteProductOpenModal({{$product->id}})"
                                               href="#.">Delete</a>
                                            <a class="dropdown-item" href="{{url('wh-editProduct')}}/{{$product->id}}">Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
...
<script>
    function deleteProductOpenModal(id) {
