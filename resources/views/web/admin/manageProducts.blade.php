    ...
    <div class="dataset__body dataset__body--panel">
      <table class="table dataset__table table__actions">
        ...
        <tr>
          ...
          <td>
            <div class="table__cell-widget">
              <span class="table__cell-widget-name">{{ $product->price }}</span>
            </div>
          </td>
          <td>
            <div class="table__cell-user">
              ...
              <div class="table__cell-user-wrap">
                <a href="#" class="table__cell-widget-name">{{ $product->created_at }}</a>
              </div>
            </div>
          </td>
          <td>
            <div class="table__cell-widget">
              <span class="table__cell-widget-name">{{ $product->updated_at }}</span>
            </div>
          </td>
