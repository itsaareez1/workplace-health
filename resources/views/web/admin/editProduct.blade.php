    ...
    <div class="container-fluid container-fh">
        <div id="form-wizard-a" class="main-container container-fh__content form-wizard-a">
            <div class="container-header">
                <h2 class="container-heading">Edit Product</h2>
            </div>
                ...
                <div class="form-wizard-a__content">
                    <div class="form-wizard-a__step-content is-current" data-step-content="1">
                        <h3 class="form-wizard-a__step-content-heading">
                            <span class="form-wizard-a__step-content-heading-icon ua-icon-lock-outline"></span> <span>Product</span>
                            Information
                        </h3>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <form class="form-wizard__step-form" method="POST" action="{{ url('updateProduct') }}"
                                      enctype="multipart/form-data">
                                    <input type="hidden" name="update_id" value="{{$product_detail->id}}">
                                    <input name="existing_img" type="hidden" value="{{$product_detail->img}}">
                                    <div class="form-group">
                                        <label for="name">Product Name</label>
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <input class="form-control" name="name" type="text"
                                                   value="{{$product_detail->name}}"
                                                   placeholder="Write name for product here!">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <select name="type" onchange="check()">
                                                ...
                                                <option
                                                    <?php echo $product_detail->type == 1 ? 'selected' : '' ?> id="Priced"
                                                    value="1">Priced Product
                                                </option>
                                                <option
                                                    <?php echo $product_detail->type == 2 ? 'selected' : '' ?> id="Pointed"
                                                    value="2">Points Product
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <input class="form-control" onchange="show()" id="image" name="image"
                                                   type="file">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <textarea class="form-control" name="description" type="text"
                                                      placeholder="Write short description for product here!">{{$product_detail->description}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <textarea class="form-control" name="specs" type="text"
                                                      placeholder="Write specifications for product here!">{{$product_detail->specification}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="priceBox"
                                         style="display:<?php echo $product_detail->type == 1 ? 'block' : 'none' ?>">
                                        <label for="price">Price</label>
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <input class="form-control" name="price" type="number"
                                                   value="{{$product_detail->price}}"
                                                   placeholder="Write price for product here!">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" id="pointsBox"
                                         style="display:<?php echo $product_detail->type == 2 ? 'block' : 'none' ?>">
                                        <label for="points">Points</label>
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <input class="form-control" name="points" type="text"
                                                   value="{{$product_detail->points}}"
                                                   placeholder="Write points for product here!">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <select id="state" name="state">
                                                ...
                                                <option
                                                    <?php echo $product_detail->state == 1 ? 'selected' : '' ?> value="1">
                                                    Coming Soon
                                                </option>
                                                <option
                                                    <?php echo $product_detail->state == 2 ? 'selected' : '' ?> value="2">
                                                    Available
                                                </option>
                                                <option
                                                    <?php echo $product_detail->state == 3 ? 'selected' : '' ?> value="3">
                                                    Out of Stock
                                                </option>
                            ...
                            <div class="col-lg-4">
                                <img id="target" src="{{asset('storage/')}}/{{$product_detail->img}}" width="100%"
