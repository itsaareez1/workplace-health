...
<div class="container-fluid container-fh">
  <div id="form-wizard-a" class="main-container container-fh__content form-wizard-a">
    <div class="container-header">
      <h2 class="container-heading">Add New Discount Voucher</h2>
    </div>
      ...
      <div class="form-wizard-a__content">
        <div class="form-wizard-a__step-content is-current" data-step-content="1">
          <h3 class="form-wizard-a__step-content-heading">
            <span class="form-wizard-a__step-content-heading-icon ua-icon-lock-outline"></span> <span>Voucher</span> Information
          </h3>
         ...
         @endif
          ...
          <div class="row">
            <div class="col-lg-4">
              <form class="form-wizard__step-form" method="POST" action="{{ url('postVoucher') }}">
                <div class="form-group">
                  <label for="title">Voucher Title</label>
                  <div class="input-group input-group-icon iconfont icon-right">
                    <input class="form-control" name="title" type="text" placeholder="Write short title for voucher here!">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group input-group-icon iconfont icon-right">
                    <textarea class="form-control" name="description" type="text" placeholder="Write short description for voucher here!"></textarea>
                    <span class="input-icon ua-icon-home"></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group input-group-icon iconfont icon-right">
                    <input class="form-control" name="code" type="text" placeholder="Write code title for voucher here!">
