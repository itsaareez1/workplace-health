<div class="navbar navbar-light navbar-expand-lg">
    ...
    <a href="/"><img src="{{ ('/admin/img/logo.png') }}" alt="" class="navbar-brand__logo"></a>
    <span class="ua-icon-menu slide-nav-toggle"></span>
  </span>

    <span class="navbar-brand-sm">
    <a href="/"><img src="{{ ('/admin/img/logo-sm.png') }}" alt="" class="navbar-brand__logo"></a>
    <span class="ua-icon-menu slide-nav-toggle"></span>
  </span>
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse">
        <div class="navbar__menu">
            ...
            <div class="navbar__menu-side">
                <div class="navbar__actions">
                    <!--          <a href="#" class="btn btn-info icon-left subnav__header-side-item">
        ...
        $obj = new \App\Http\Controllers\AdminController();
        $notification = $obj->user_order_notification_list();
        //        print_r($notification);
        $badge = $notification['total_count'];
        //        print_r($notification['total_count']);
        //        echo '<br>';
        //        print_r($notification['records_list']);
        ?>

        <div class="dropdown navbar-dropdown no-arrow navbar-notify-dropdown">
            <a class="dropdown-toggle navbar-dropdown-toggle" data-toggle="dropdown" href="#" role="button"
        ...
        <span class="navbar-notify navbar-notify--notifications">
         ...
         <span class="navbar-notify__amount"><?php echo $badge ?></span>
        </span>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown-menu navbar-dropdown-notifications">
                ...
                <div class="navbar-dropdown-notifications__body js-scrollable">
                    ...
                    <?php
                    if (!empty($notification['records_list'])) {
                        print_r($notification['records_list']);
                    } else {
                        echo '<div class="navbar-dropdown-notifications__body-empty"><img
                                    class="navbar-dropdown-notifications__body-empty-image"
                                    src="/admin/img/empty-notifications.png" alt=""/>
                            <div class="navbar-dropdown-notifications__body-empty-text">You`re up to date!</div>
                        </div>';
                    }
                    ?>
                </div>
                <a class="navbar-dropdown-notifications__view-all" href="{{url('wh-manageOrders')}}"><span
                            class="icon ua-icon-view-all"></span><span>View all</span></a>
            </div>
        </div>
        ...
        <div class="dropdown navbar-dropdown">
            <a class="dropdown-toggle navbar-dropdown-toggle navbar-dropdown-toggle__user" data-toggle="dropdown"
               href="#">
                <img src="{{asset('/admin/img/users/user-3.png')}}" alt="" class="navbar-dropdown-toggle__user-avatar">
                <span class="navbar-dropdown__user-name">{{ session()->get('name') }}</span>
            </a>
            <div class="dropdown-menu navbar-dropdown-menu navbar-dropdown-menu__user">
                <div class="navbar-dropdown-user-content">
                    <div class="dropdown-user__avatar"><img src="{{asset('/admin/img/users/user-3.png')}}" alt=""/></div>
                    <div class="dropdown-info">
                        <div class="dropdown-info__name">{{ session()->get('name') }}</div>
                        <div class="dropdown-info__job">Administrator</div>
                    </div>
                </div>
                <a class="dropdown-item navbar-dropdown__item" href="{{ url('signout') }}">Sign Out</a>
            </div>
        </div>
    </div>
</div>
