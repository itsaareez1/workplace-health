    ...
    <div class="container-fluid container-fh">
        <div id="form-wizard-a" class="main-container container-fh__content form-wizard-a">
            <div class="container-header">
                <h2 class="container-heading">Edit A Company</h2>
            </div>
                ...
                <div class="form-wizard-a__content">
                    <div class="form-wizard-a__step-content is-current" data-step-content="1">
                        <h3 class="form-wizard-a__step-content-heading">
                            <span class="form-wizard-a__step-content-heading-icon ua-icon-lock-outline"></span> <span>Company</span>
                            Information
                        </h3>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <form class="form-wizard__step-form" method="POST" action="{{ url('updateCompany') }}">
                                    <input type="hidden" name="update_id" value="{{$company_detail->id}}">
                                    <div class="form-group">
                                        <label for="username">Name of Company</label>
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <input class="form-control" name="name" type="text"
                                                   value="{{ $company_detail->name }}" placeholder="Write name here!">
                                        ...
                                        <div class="input-group input-group-icon iconfont icon-right">
                                            <select id="district" name="district_id">
                                                ...
                                                @foreach($results as $district)
                                                    <option
                                                        <?php echo $company_detail->district_id == $district->id ? 'selected' : ''?> value="{{ $district->id }}">{{ $district->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
