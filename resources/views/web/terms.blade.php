...
@section('content2')
    ...
    <div class="site-section">
        <div class="container">
            <div class="column">
                <strong><h2 align="center">Individual Declaration and Indemnity for first-time Physical Activity
                        Participant</h2></strong>
            </div>
            <div style="padding: 20px 20px; text-align:justify;" class="column">
                ...
                <p>
                    ...
                    medical status and history, or assess my individual health risk. Whilst reasonable precautions will
                    be
                    taken by HPB and the fitness partner(s) to ensure the safety of participants, participants take part
                    at
                    their own risks and it remains my personal responsibility to ensure I are medically fit and ready to
                    take part in any activity I have registered for. HPB, the fitness partner, and their appointed
                    officials
                ...
                <form method="post" action="{{url('terms')}}">
                    ...
                    <table style="width:60%;  border: 1px solid black; margin: 0 auto;">
                        ...
                        <tr style=" border: 1px solid black;">
                            ...
                            <td><input style="padding: 0 5px;" type="text" name="signature" required>
                                <span class="focus-input100" style="color: red">{{ $errors->first('signature') }}</span>
                            </td>
                        </tr>
                        <tr style=" border: 1px solid black;">
                    ...
                    <p>
                        ...
                        If you have answered <b>‘YES’</b> to any of the questions below, you are required to be
                        evaluated
                    ...
                    <table style="width:90%;  border: 1px solid black; margin: 0 auto;">
                        <tr style="border: 1px solid black;">
                            <th colspan="3" style=" border: 1px solid black; width: 20%;  padding: 5px; ">Please read
                                each question carefully and answer to your best knowledge by circling on the form:<br/>
                                请仔细阅读每一个问题，并在表格上依您所知圈出适合的答案：
                            </th>

                        </tr>
                        <tr style=" border: 1px solid black;">
                            <th style=" border: 1px solid black; width: 90%;  padding: 5px; ">1. Has anyone in your
                                immediate family (mother, father, sister or brother) had a heart attack or
                                died suddenly of a heart related disorder before age 55 (men) or 65 (women)?<br/><br/>
                                您的直系亲属中（爸爸、妈妈、姐姐、妹妹、哥哥或弟弟）是否有人在 55 岁（男性）或65（
                                女性）之前，曾心脏病发作或死于与心脏失调病有关？<span class="focus-input100"
                                                              style="color: red">{{ $errors->first('q1') }}</span></th>
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q1"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q1"
                                                                                                value="0" required><br/>否
                            </td>

                        </tr>
                        <tr style=" border: 1px solid black;">
                            <th style=" border: 1px solid black; width: 90%;  padding: 5px; ">2. Has your doctor
                                informed you that you have any of these conditions? (check all that apply)<br/>
                                
                            ...
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q2"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q2"
                                                                                                value="0" required><br/>否
                            </td>
                        ...
                        <tr style=" border: 1px solid black;">
                            <th style=" border: 1px solid black; width: 90%;  padding: 5px; ">3.
                                Has your doctor informed you that you have any of these conditions? (check all that
                                apply)<br/>
                            ...
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q3"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q3"
                                                                                                value="0" required><br/>否
                            </td>
                        ...
                        <tr style=" border: 1px solid black;">
                            <th style=" border: 1px solid black; width: 90%;  padding: 5px; ">4.
                                In the past 1 year, have you had chest pain when you engage in physical activity or when
                                at
                                rest?<br/><br/>
                                在过去1年里，您是否曾在进行体力活动时或没有进行任何活动时感到胸口疼痛？
                            </th>
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q4"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q4"
                                                                                                value="0" required><br/>否
                            </td>
                        ...
                        <tr style=" border: 1px solid black;">
                            ...
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q5"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q5"
                                                                                                value="0" required><br/>否
                            </td>
                        ...
                        <tr style=" border: 1px solid black;">
                            <th style=" border: 1px solid black; width: 90%;  padding: 5px; ">6.
                                Do you have any bone, joint or muscle problem (e.g. back, knee, hip, shoulder or ankle)
                                that
                                could be made worse by participating in exercise?<br/><br/>
                                您的骨骼、关节或肌肉（例如脊椎、膝盖、髋、肩膀或脚踝）是否有可能因参与运动而恶化？
                            </th>
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q6"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q6"
                                                                                                value="0" required><br/>否
                            </td>
                        ...
                        <tr style=" border: 1px solid black;">
                            <th style=" border: 1px solid black; width: 90%;  padding: 5px; ">7.
                                Do you take tablets for high blood pressure and either continue to have poorly
                                controlled
                                high blood pressure, or you do not follow up with a doctor on a regular basis?<br/><br/>
                                您是否正在服用治疗高血压的药物，同时高血压情况控制不佳，或没有定期和医生跟进？
                            </th>
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q7"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q7"
                                                                                                value="0" required><br/>否
                            </td>

                        </tr>
                        <tr style=" border: 1px solid black;">
                            <th style=" border: 1px solid black; width: 90%;  padding: 5px; ">8. Are you currently
                                pregnant? (Female participants to note: If you are currently pregnant,
                            ...
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q8"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q8"
                                                                                                value="0" required><br/>否
                            </td>
                        ...
                        <tr style=" border: 1px solid black;">
                            <th style=" border: 1px solid black; width: 90%;  padding: 5px; ">9. Do you know of any
                                reason why participating in this HPB exercise programme or any other
                                physical activity might be harmful to your health?<br/><br/>
                                是否有任何原因会令参与此 保健促进局运动计划或任何其它体力活动可能对您的健康造成危害？
                            </th>
                            <td style=" border: 1px solid black;  padding: 5px;">Yes <br/><input type="radio" name="q9"
                                                                                                 value="1"
                                                                                                 required><br/>是
                            </td>
                            <td style=" border: 1px solid black;  padding: 5px;">No <br/><input type="radio" name="q9"
                                                                                                value="0" required><br/>否
                            </td>
                    ...
                    <div class="row" style="margin-top: 25px;">
                        ...
                        <div class="col-lg-4">
                            <div class="container-login100-form-btn">
                                <input style="text-align: center;" class="login100-form-btn" type="submit"
                                       value="Sign up">
