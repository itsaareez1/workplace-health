            ...
            <div class="wrap-login100 p-t-85 p-b-20">
                ...
                <form class="login100-form validate-form" method="POST" action="{{ url('upPro') }}">
                            ...
                            <div class="col-lg-12">
                                <div class="alert action-alert action-alert--danger has-btn" role="alert">
                                  <span class="action-alert__message">
                                      <span class="action-alert__action-message">{{ session()->get('status') }}
                                    </span>
                                </span>
                                </div>
                            </div>
                        ...
                        <select name="gender" style="border: 0; color: #c5c8cc; padding: 10px 0" class="input100">
                            ...
                            @elseif ($user->salutation == "Ms.")
                                <option disabled selected
                                        value="{{ $user->salutation }}">{{ $user->salutation }}</option>
                                <option value="Mr.">Mr.</option>
                    ...
                    <div class="wrap-input100 validate-input m-b-50" data-validate="">
                        ...
                        <p dir="rtl" align="right"><a href="{{url('verifyAccount1')}}" class="txt2">Verify Phone
                                Number</a></p>
                    </div>

                    <div class="wrap-input100 validate-input m-b-50" data-validate="">
                        <input class="input100" type="email" name="email" value="{{ $user->email }}"><a href="#"
                                                                                                        class="txt2">
                            <span class="focus-input100" data-placeholder="" dir="rtl" align="right"></span>
                            <p dir="rtl" align="right"><a href="{{url('verifyAccount2')}}" class="txt2">
                            <p dir="rtl" align="right">Verify Email</a></p>
                    </div>
