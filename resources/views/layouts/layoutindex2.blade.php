                                ...
                                <div class="container">
                                    ...
                                    @if (session()->has('usr_id'))
                                        <ul class="site-menu js-clone-nav d-none d-lg-block">
                                            ...
                                            <li><a href="{{url('program')}}">Sparkshealth programmm</a></li>
                                            ...
                                            <li class="has-children"><a href="#"><i class="fa fa-user"></i>
                                                ...
                                                <ul class="dropdown arrow-top">
                                                    {{--<li><a href="{{url('index')}}"><i class="fa fa-home"></i> Dashboard</a>--}}
                                                    {{--</li>--}}
                                    ...
                                    @else
                                        <ul class="site-menu js-clone-nav d-none d-lg-block">
                                            ...
                                            <li><a href="{{url('welcome')}}">Home</a></li>
                                            <li><a href="{{url('program')}}">Sparkshealth programm</a></li>
                                            <li><a href="{{url('store')}}">Store</a></li>
                                            <li><a href="{{url('loyalty')}}">Loyalty Programme</a></li>
                                            <li><a href="{{url('help')}}"> FAQs</a></li>
                                            <li><a href="{{url('contact')}}">Contact</a></li>
...
{{--<script src="{{asset('/web/js/jquery-3.3.1.min.j  s')}}"></script>--}}
